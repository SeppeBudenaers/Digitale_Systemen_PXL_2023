...
HD_PWD='C:/02_PXL/01_Digitale_Systemen/Labo/Oef_2/Oef_2.runs/design_1_optellen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_optellen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_optellen_0_0.tcl
