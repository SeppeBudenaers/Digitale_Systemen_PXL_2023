...
HD_PWD='C:/01_project/DMX_FPGA/DMX_pynqz2/DMX_pynqz2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Clock_Divider_250khz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Clock_Divider_250khz.tcl
