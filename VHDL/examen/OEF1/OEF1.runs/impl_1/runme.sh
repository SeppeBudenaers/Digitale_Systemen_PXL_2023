...
HD_PWD='C:/02_PXL/01_Digitale_Systemen/examen/OEF1/OEF1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seppe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seppe.tcl -notrace
