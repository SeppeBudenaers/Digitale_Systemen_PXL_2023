...
HD_PWD='C:/02_PXL/01_Digitale_Systemen/examen/OEF1/OEF1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seppe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seppe.tcl
