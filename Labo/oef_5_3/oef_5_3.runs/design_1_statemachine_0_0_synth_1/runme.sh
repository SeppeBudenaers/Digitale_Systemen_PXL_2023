...
HD_PWD='C:/02_PXL/01_Digitale_Systemen/Labo/Labo_3_oef_1/Labo_3_oef_1.runs/design_1_statemachine_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_statemachine_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_statemachine_0_0.tcl
