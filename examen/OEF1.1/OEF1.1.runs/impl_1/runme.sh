...
HD_PWD='C:/01_project/DMX_FPGA/DMX_pynqz2/DMX_pynqz2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Clock_Divider_250khz.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Clock_Divider_250khz.tcl -notrace
